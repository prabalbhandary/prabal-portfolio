...
const projects = [
  { id: 1, title: 'Mak Movies Frontend', image: '/images/project-1.png', description: 'This is a movie app frontend build with Next JS.', link: 'https://movie-app-two-drab-68.vercel.app/' },
  { id: 2, title: 'Mak Movies Backend', image: '/images/project-2.png', description: 'This is a movie app backend build with Next JS.', link: 'https://movie-app-two-drab-68.vercel.app/' },
